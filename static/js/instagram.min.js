  ...
  Instafeed = (function() {
    ...
    Instafeed.prototype.parse = function(response) {
      ...
      if ((typeof document !== "undefined" && document !== null) && this.options.mock === false) {
        ...
        if ((this.options.template != null) && typeof this.options.template === 'string') {
          ...
          for (_i = 0, _len = images.length; _i < _len; _i++) {
            ...
            imageString = this._makeTemplate(this.options.template, {
              ...
              caption: this._getObjectProperty(image, 'caption.text') ? this._getObjectProperty(image, 'caption.text').replace(/(\w{30,})/, '') : null,
          ...
          document.getElementById(this.options.target).innerHTML = document.getElementById(this.options.target).innerHTML + htmlString;
        } else {
        ...
        max_id = response.pagination.next_max_tag_id;
